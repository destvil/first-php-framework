        ...
        <div class="top-header-main">
            ...
            <div class="col-md-6 top-header-left">
                ...
                <div class="cart box_1">
                    <a href="/cart/show" class="check-cart"">
                        <div class="total">
                            <img src="/images/cart-1.png" alt="cart img">
              ...
              <div class="btn-group account-dropdown">
                <button class="dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                  <?php if(!empty($_SESSION['user'])): ?>
                    Добро пожаловать, <?=hsc($_SESSION['user']['name']);?>
                  <?php else: ?>
                   Account
                  <?php endif; ?>
...
<div class="header-bottom">
    <div class="container">
        <div class="header">
            ...
            <div class="col-md-3 header-right vcenter">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="clearCart-button" type="button" class="btn btn-danger">Очистить корзину</button>
            </div>
        </div>
    </div>
</div>
