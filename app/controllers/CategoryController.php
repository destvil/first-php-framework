...
class CategoryController extends AppController
{
    public function viewAction()
    {
        ...
        $this->setMeta('Категория: ' . $category->title . ' | ' . App::$app->getProperty('shop_name'), $category->description, $category->keywords);
        $this->set(compact('breadcrumbs', 'products', 'pagination'));
    }
}