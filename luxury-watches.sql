...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 13 2019 г., 13:33
...
(21, 'Тестовая категория', 'testovaya-kategoriya', 0, '11', '22'),
(22, 'Тестовая категория 2', 'testovaya-kategoriya-2', 21, '321', '312');
...
(1, 12, '1', '2019-08-13 10:17:56', '2019-08-13 09:32:29', 'USD', 'Измененный заказ №1'),
(2, 12, '0', '2019-08-13 10:20:22', NULL, 'USD', 'Заказ №1'),
(3, 12, '0', '2019-08-13 10:20:53', NULL, 'USD', 'Заказ №2'),
(4, 12, '0', '2019-08-13 10:21:14', NULL, 'USD', 'Заказ №4'),
(5, 12, '1', '2019-08-13 10:21:29', '2019-08-13 09:32:37', 'USD', 'Измененный заказ №5'),
(6, 12, '0', '2019-08-13 10:21:54', NULL, 'RUB', 'Заказ №6'),
(7, 12, '0', '2019-08-13 10:22:13', NULL, 'UAH', 'Заказ №7'),
(8, 12, '0', '2019-08-13 10:22:38', NULL, 'EUR', 'Заказ №8'),
(9, 12, '0', '2019-08-13 10:22:56', NULL, 'EUR', 'Заказ №9'),
(10, 12, '0', '2019-08-13 10:32:21', NULL, 'RUB', 'Заказ №10');
...
(1, 1, 2, 3, 'Casio MQ-24-7BUL', 70),
(2, 1, 3, 1, 'Casio GA-1000-1AER', 400),
(3, 1, 7, 1, 'Q&Q Q956J302Y', 20),
(4, 2, 2, 3, 'Casio MQ-24-7BUL', 70),
(5, 2, 3, 1, 'Casio GA-1000-1AER', 400),
(6, 2, 7, 1, 'Q&Q Q956J302Y', 20),
(7, 3, 7, 1, 'Q&Q Q956J302Y', 20),
(8, 3, 8, 1, 'Royal London 41040-01', 90),
(9, 3, 11, 1, 'Тестовый товар', 10),
(10, 3, 2, 1, 'Casio MQ-24-7BUL', 70),
(11, 4, 3, 1, 'Casio GA-1000-1AER', 400),
(12, 5, 3, 1, 'Casio GA-1000-1AER', 400),
(13, 5, 11, 2, 'Тестовый товар', 10),
(14, 6, 11, 2, 'Тестовый товар', 632.8),
(15, 6, 5, 1, 'Citizen BJ2111-08E', 31640),
(16, 6, 17, 1, 'Часы 6', 7593.6),
(17, 6, 16, 1, 'Часы 5', 7277.2),
(18, 7, 11, 2, 'Тестовый товар', 258),
(19, 7, 6, 1, 'Citizen AT0696-59E', 9030),
(20, 7, 8, 2, 'Royal London 41040-01', 2322),
(21, 7, 5, 1, 'Citizen BJ2111-08E', 12900),
(22, 8, 10, 1, 'Royal London 41156-02', 88),
(23, 8, 8, 1, 'Royal London 41040-01', 79.2),
(24, 8, 9, 1, 'Royal London 20034-02', 96.8),
(25, 9, 3, 10, 'Casio GA-1000-1AER (Silver)', 352),
(26, 10, 1, 1, 'Casio MRP-700-1AVEF', 18984),
(27, 10, 1, 1, 'Casio MRP-700-1AVEF (Dark Black)', 19300.4),
(28, 10, 1, 1, 'Casio MRP-700-1AVEF (Red)', 19616.8),
(29, 10, 1, 1, 'Casio MRP-700-1AVEF (Black)', 18984);
...
(7, 6, 3, 'Q&Q Q956J302Y', 'q-and-q-q956j302y', NULL, 20, 125, '1', NULL, NULL, 'p-7.png', '1'),
(8, 8, 4, 'Royal London 41040-01', 'royal-london-41040-01', NULL, 90, 0, '1', NULL, NULL, 'p-8.png', '1'),
(9, 8, 4, 'Royal London 20034-02', 'royal-london-20034-02', NULL, 110, 0, '1', NULL, NULL, 'no_image.jpg', '0'),
...
(12, 'admin', '$2y$10$dr0aLf.ztSjR/qxyRriIsekj8IQ/CCt3riH2aUkJvx4A0kXF5GAf.', 'destvil.dev@gmail.com', 'Admin', '...', 'admin');
...
ALTER TABLE `attribute_product`
  ADD KEY `attr_id` (`attr_id`,`product_id`) USING BTREE,
...
ALTER TABLE `attribute_product`
  ...
  ADD CONSTRAINT `attribute_product_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE;

--
-- Ограничения внешнего ключа таблицы `attribute_value`
--
ALTER TABLE `attribute_value`
  ADD CONSTRAINT `attribute_value_ibfk_1` FOREIGN KEY (`attr_group_id`) REFERENCES `attribute_group` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `modification`
  ADD CONSTRAINT `modification_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE CASCADE;
